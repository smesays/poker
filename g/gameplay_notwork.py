...
class Gameplay():
    ...
    def responding(self, betagent, resagent, betagent_check, resagent_check, resprompt, resagent_fold): # responses after a bet
...
#            print 'audit1: a1totbet, a2totbet = ', self.agent1.allbets, self.agent2.allbets
            if self.agent1.allbets > self.agent2.allbets:
                self.responding(self.agent1, self.agent2, agent1_check, agent2_check, 2, self.agent2_fold)

            elif self.agent1.allbets < self.agent2.allbets:
                self.responding(self.agent2, self.agent1, agent2_check, agent1_check, 1, self.agent1_fold)
