...
agent_log = np.genfromtxt('../log/agent_log20180222.txt', delimiter=',', usecols = [0,2,3], dtype=int)
# numpy array format: [tourneynum, style, win(1)/lose(-1)]
...
print 'audit: this number should be zero: ', len(audit)
