...
#dodo        
        return '> (C)all $%d, (R)aise, (A)ll-in $%d, or (F)old? Enter c, r, a, or f: ' % (callamt, min(self.agent1.balance, self.agent2.balance)),
...
#                    betact = raw_input('                                                                   > (C)all, (R)aise, (A)ll-in, or (F)old? Enter c, r, a, or f: ')
                    print ' '*self.GAME_INDENT, '> (C)all $%d, (R)aise, (A)ll-in $%d, or (F)old? Enter c, r, a, or f: ' % (callamt, min(self.agent1.balance, self.agent2.balance)),
                    betact = raw_input(' ')
                    betact = betact.lower()
                    betamt = 0
