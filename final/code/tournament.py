...
#    print game_stat_log
    ...
    if SIMULATE:
        '''
        f = open("../log/agent_fulllog20180222_10k.txt", "a")
        ...
        f.close()
        '''
        f = open("../log/gamestat_fulllog20180222_10k.txt", "a")
        ...
        if gamenum < 3:
            pass
            '''
            f = open("../log/agent_shortlog20180222_10k.txt", "a")
            for i in range(len(agent_log)):
                f.write("%d"%tourneynum)
                f.write(",")
                f.write(",".join(map(lambda x: str(x), agent_log[i])))
            ...
            f = open("../log/agent_log20180222_10k.txt", "a")
            for i in range(len(agent_log)):
                f.write("%d"%tourneynum)
                f.write(",")
            ...
            f = open("../log/tourney_log20180222_10k.txt", "a")
